...
//////////////////////////
  ...
  //
    ...
    #define LCD_PINS_D7                       64
      ...
      #else
//        #define LCD_PINS_RS                   16  // Artillery Genius Change
        #define LCD_PINS_RS                   27    // Artillery Genius Change
        #define LCD_PINS_ENABLE               17
        #define LCD_PINS_D4                   23
//        #define LCD_PINS_D5                   25   // Artillery Genius Change
//        #define LCD_PINS_D6                   27    // Artillery Genius Change
        #define LCD_PINS_D5                   31    // Artillery Genius Change
        #define LCD_PINS_D6                   33    // Artillery Genius Change
      #endif
